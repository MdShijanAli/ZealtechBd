            ...
            <div class="col-md-12">
                <div class="form-area">
                    <div class="d-flex justify-content-between heading">
                        <h4 class=""><i class="fa fa-edit"></i> Edit new Service</h4>
                        <div>
                    ...
                    <form action="{{ route('services.update', $service) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" id="name" type="text" name="name" value="{{ $service->name }}">
                                @error('name')
                            ...
                            <div class="col-md-4 offset-md-1">
                                <img class="form-controlo img-thumbnail" src="{{ asset($service->icon) }}" style="width: 80px;height: 80px; background: #3f4a49;">
                            </div>
