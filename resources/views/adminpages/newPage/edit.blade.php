                    ...
                    <form action="{{ route('pages.update',$page->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" id="name" type="text" name="name" value="{{ $page->name }}" placeholder="Enter name">
                                @error('name')
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input class="form-control" id="title" type="text" name="title" value="{{  $page->title }}" placeholder="Enter Page title">
                            </div>
                            <div class="col-md-6 mb-2">
                                <label for="sub_title">Page Sub Title <span class="text-danger"> * </span></label>
                                <input class="form-control" id="sub_title" type="text" name="sub_title" value="{{  $page->sub_title }}" placeholder="Enter Sub title">
                            </div>
