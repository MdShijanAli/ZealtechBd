            ...
            <div class="col-md-12">
                <div class="form-area">
                    <div class="d-flex justify-content-between heading">
                        <h4 class=""><i class="fa fa-user-plus"></i> Add new Client</h4>
                        <div>
                    ...
                    <form action="{{ route('client.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" id="name" type="text" name="name" value="{{ old('name') }}" placeholder="client company name">
                                @error('name')
                        ...
                        <tbody>
                            @forelse ($clients as $key=>$client)
                                <tr>
                                    ...
                                    <td>{{ $client->name }}</td>
                                    <td>{{ $client->slug }}</td>
                                    <td><img class="border" style="height: 40px; width:50px;" src="{{ asset($client->image) }}" alt=""></td>
                                    <td>
                                        <a href="{{ route('client.edit',$client) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                                        <button type="submit" class="btn btn-danger btn-sm" onclick="deleteClient({{ $client->id }})"><i class="fa fa-trash"></i></button>
